            ...
            <div className="p-14">
              ...
              <div className="mt-10 grid grid-cols-3 gap-3">
                <div className="text-white font-bold">
                  <div className="text-[25px]">10+k</div>
                  <div className="uppercase text-[11px]">Companies</div>
                </div>
                <div className="text-white font-bold">
                  <div className="text-[25px]">314</div>
                  <div className="uppercase text-[11px]">Templates</div>
                </div>
                <div className="text-white font-bold">
                  <div className="text-[25px]">12M+</div>
                  <div className="uppercase text-[11px]">Queries</div>
                </div>
              </div>
            </div>
          </aside>
